            ...
            <div className="Footer">
                ...
                >
                    ...
                    <Modal.Body className="modaaaal">
                        <a href="mailto:CO2x2finance@gmail.com">
                            <img src="images/Group164.png" alt="Mail" />
                        </a>
                        <a href="https://t.me/tech_support_ashcom_bot">
                            <img src="images/Group165.png" alt="Telegram" />
                        </a>
                    </Modal.Body>
                </Modal>
                <Modal
                ...
                >
                    ...
                    <Modal.Body className="ModalBodyHelp">
                        <p>
                            Якщо у Вас нестандартний випадок або складна
                            ситуація, яка потребує кваліфікованої юридичної
                            допомоги – зазначте номер Вашого телефону. Наш
                            адвокат невідкладно зв’яжеться з Вами.
                        </p>
                        <div>
                            <label>
                                <input
